...
public class UtjMeelMain extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.utj_meel_main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.action_logout:
                Communication.getInstance().logOut(getApplicationContext());
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_utj_meel_main, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((UtjMeelMain) activity).onSectionAttached(
